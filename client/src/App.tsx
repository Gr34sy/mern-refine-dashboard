...
function App() {
  const authProvider: AuthBindings = {
    login: async ({ credential }: CredentialResponse) => {
      ...
      if (profileObj) {
        const response = await fetch("https://mern-refine-dashboard-7kur.onrender.com/api/v1/users", {
          method: "POST",
    ...
    <BrowserRouter>
      <RefineKbarProvider>
        <ColorModeContextProvider>
          ...
          <RefineSnackbarProvider>
            <Refine
              dataProvider={dataProvider("https://mern-refine-dashboard-7kur.onrender.com/api/v1")}
